...
# Sinh mat khau 14 ky tu (tranh net.exe hoi xac nhan khi pass > 14 ky tu)
# Bo cac ky tu de nham lan: 0/O, 1/l/I
...
# TAO USER BANG net.exe — on dinh tren moi image
...
# BAT BUOC kiem tra: password phai dang nhap duoc Windows (LogonUser API)
